...
<template>
  ...
  >
    <article data-page="about">
      ...
      <section
        class="glass p-6 text-sm md:text-lg text-justify flex flex-col gap-6 md:flex-row md:gap-10 md:items-center"
      >
        <!-- Foto -->
        <div class="flex justify-center md:w-5/12">
          <img
            class="w-8/12 md:w-full rounded-2xl fadein-up"
            src="/foto.jpg"
            alt="Foto"
          />
        </div>
        ...
        <!-- Text -->
        <div class="md:w-7/12">
          <p class="mb-4 text-white fadein-left fadeins-1">
            I'm Ananda Anugrah Handyanto
          </p>
          <p class="mb-4 text-muted fadein-left fadeins-1">
            Hello! I'm a 22-year-old tech enthusiast based in West Java,
            Indonesia. I graduated from a vocational high school majoring in
            Computer and Network Engineering. I enjoy improving my coding skills
            and exploring technology.
          </p>

          <p class="text-muted fadein-left fadeins-2">
            I specialize in: Developing Custom ROMs, Linux Kernels, Custom
            Recovery, and Website Development.
          </p>
        </div>
      </section>
    </article>
