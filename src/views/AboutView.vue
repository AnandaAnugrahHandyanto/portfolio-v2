    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 5,
          name: 'C',
          imageUrl: 'https://img.icons8.com/?size=100&id=40670&format=png&color=000000',
          status: 'Beginner'
        },
        {
          id: 6,
        ...
        },
        {
          id: 7,
          name: 'Kotlin',
          imageUrl: 'https://img.icons8.com/?size=100&id=ZoxjA0jZDdFZ&format=png&color=000000',
          status: 'Beginner'
        },
        {
          id: 8,
      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; I'm Ananda Anugrah Handyanto<br />Hello! I'm a 20-year-old tech enthusiast based in
            West Java, Indonesia. I graduated
            from a vocational high school with a major in Computer and Network Engineering. My passion lies in
            continuously honing my coding skills and diving deep into the world of technology.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I specialize in:
            Developing Custom ROMs: Bringing personalized and optimized experiences to mobile devices.
            Linux Kernels: Enhancing performance and stability for various Linux distributions.
            Custom Recovery: Creating robust recovery solutions for Android devices.
            Website Development: Crafting interactive and user-friendly websites.
          </p>
        </div>
