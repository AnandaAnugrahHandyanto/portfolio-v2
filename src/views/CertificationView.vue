  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: "Develop Applications with Alibaba Cloud Services",
          imageUrl: "developaplication",
          status: "By Alibaba Cloud.",
        },
        {
          id: 2,
          name: "Learn Basic Web Programming HTML",
          imageUrl: "html",
          status: "By Alibaba Cloud x Codepolitan x Developer Handal.",
        },
        {
          id: 3,
          name: "Learn Basic Web Programming CSS",
          imageUrl: "css",
          status: "By Alibaba Cloud x Codepolitan x Developer Handal.",
        },
        {
          id: 4,
          name: "Learn Basic Web Programming Bootstrap CSS Framework",
          imageUrl: "bootstrapcss",
          status: "By Alibaba Cloud x Codepolitan x Developer Handal.",
        },
        {
          id: 5,
...
<template>
  <div class="glass py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      <header>
        ...
        >
          <h4>Certification</h4>
          <h4
            class="p-4 text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-amber-300"
          >
            Welcome to my certification gallery. Here, you can see the official
            recognitions I've received for my skills and knowledge in web
            development and related fields. Each certificate represents a
            milestone in my ongoing professional development
          </h4>
        </div>
      </header>
      <section>
        <div>
          <div
            class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 fade-zoom-in"
          >
              ...
              >
                ...
                >
                  <img
                    ...
                    :src="
                      '/certification/certification-' + item.imageUrl + '.png'
                    "
                  />
                </div>
                <div
